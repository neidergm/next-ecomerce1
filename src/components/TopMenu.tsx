import { getCookieCart } from '@/shopping-cart/actions/cart-actions';
...
export const TopMenu = async () => {
  ...
  const items = Object.values(cart).reduce((acc, item) => acc + item, 0);
      ...
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          <Link href="/dashboard/cart"
            className="px-3 flex items-center justify-center h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200"
          >
            {!!items &&
              <span className='font-bold mr-2 text-blue-600'>{items}</span>
            }
